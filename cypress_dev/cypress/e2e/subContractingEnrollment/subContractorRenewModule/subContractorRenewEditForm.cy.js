...
import {subContractorRenewAddForm, subContractorRenewEditSubmitFormOpen, deputyGeneralManagerStep1, assistantEngineerOrExecutiveOfficerStep2, deputyGeneralManagerStep3, govtPaymentFinalStep, certificateButtonCheck, viewBladeSectionsCheck} from "../../../pages/subContractingEnrollment/subContractorRenewModule/subContractorRenewEditForm"

describe('Cypress Automation for Sub Contractor Renew Edit Form', () => {
    beforeEach(() => {
    ...
    it('should execute open edit blade and complete for payment', () => 
    {
        ...
        applicantLoginPage();
        subContractorRenewEditSubmitFormOpen();
        applicantLogoutPage();
    ...
    {    
        ...
        deskUserLoginPage();
        deputyGeneralManagerStep3();
        applicantLogoutPage();

    })

    it('should execute govtPayment Step5 final approval', () => 
    {    
        // Step 4: Final approval from applicant
        applicantLoginPage();
        govtPaymentFinalStep();
        applicantLogoutPage();
