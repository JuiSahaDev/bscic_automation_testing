...
import {subContractorNewAddForm, subContractorNewEditSubmitFormOpen, deputyGeneralManagerStep1, assistantEngineerOrExecutiveOfficerStep2, deputyGeneralManagerStep3, govtPaymentFinalStep, certificateButtonCheck, viewBladeSectionsCheck} from "../../../pages/subContractingEnrollment/subContractorNewModule/subContractorNewEditForm"

describe('Cypress Automation for Sub Contractor New Edit Form', () => {
    beforeEach(() => {
    ...
    it('should execute open edit blade and complete for payment', () => 
    {
        ...
        applicantLoginPage();
        subContractorNewEditSubmitFormOpen();
        applicantLogoutPage();
