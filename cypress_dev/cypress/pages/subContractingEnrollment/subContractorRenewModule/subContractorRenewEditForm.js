...
export const subContractorRenewAddForm = () => {
    ...
    cy.get('#company_type_id option', { timeout: 20000 }).should('have.length.greaterThan', 1)
    cy.get('#company_type_id', { timeout: 20000 }).should('be.visible').select('2', { force: true }) // জমির পরিমান একক
...
// step0: Applicant industrial new registration
export const subContractorRenewEditSubmitFormOpen = () => {
