// step0: Applicant contractor add re-registration form filling and submission
export const contractorReRegistrationAddForm = () => {
    ...
    cy.wait(2000);
    cy.get('#manual_reg_number:visible').first().should('exist').clear().type('CON-20250224-Manual', { force: true })
    cy.wait(2000);
