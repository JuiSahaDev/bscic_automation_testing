...
import { industrialAmendmentAddForm, industrialAmendmentEditSubmitFormOpen, extensionOfficer9thGradeOrEquivalentStep1, assistantGeneralManager6thGradeOrEquivalentFinalStep, certificateButtonCheck, viewBladeSectionsCheck } from "../../../pages/industrialRegistration/industrialRegistrationAmendmentModule/industrialRegistrationAmendmentModuleEditForm"

describe('Cypress Automation for Industrial Registration Amendment Edit Blade Testing', () => {
    beforeEach(() => {
    ...
    it('should execute open edit blade and complete for payment', () => 
    {
        // Step 0: Applicant registration
        applicantLoginPage();
        industrialAmendmentEditSubmitFormOpen();
        applicantLogoutPage();
