// Industrial Cancellation Test Script for applicant and Desk User
import { applicantLoginPage, deskUserLoginPage, applicantLogoutPage } from "../../../pages/login"
import { industrialCancellationAddForm, industrialCancellationEditSubmitFormOpen, extensionOfficer9thGradeOrEquivalentStep1, assistantGeneralManager6thGradeOrEquivalentFinalStep, certificateButtonCheck, viewBladeSectionsCheck } from "../../../pages/industrialRegistration/industrialRegistrationCancellationModule/industrialRegistrationCancellationModuleEditForm"

describe('Cypress Automation for Industrial Registration Cancellation Edit Blade Testing', () => {
    beforeEach(() => {
    ...
    it('should execute open edit blade and complete for payment', () => 
    {
        // Step 0: Applicant registration
        applicantLoginPage();
        industrialCancellationEditSubmitFormOpen();
        applicantLogoutPage();
