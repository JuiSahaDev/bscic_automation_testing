// Contractor Amendment Test Script for applicant and Desk User
import { applicantLoginPage, deskUserLoginPage, applicantLogoutPage } from "../../../pages/login"
import { contractorAmendmentAddForm, technicalOfficerAssistantEngineerStep1, deputyChiefEngineerStep2, chiefEngineerStep3, certificateButtonCheck, viewBladeSectionsCheck } from "../../../pages/contractorRegistration/contractorRegistrationAmendmentModule/contractorRegistrationAmendmentAddForm"

describe('Cypress Automation for Contractor Amendment Add Blade Testing', () => {
    beforeEach(() => {
    ...
    it.skip('should execute complete contractor registration amendment workflow', () => 
    {
        // Step 0: Applicant registration
        applicantLoginPage();
        contractorAmendmentAddForm();
        applicantLogoutPage();

    })

    it.skip('should execute technicalOfficerAssistantEngineer Step1 desk user processing', () => 
    {    
    ...
    it.skip('should execute deputyChiefEngineer Step2 desk user processing', () => 
    {    
    ...
    it.skip('should execute chiefEngineer Step3 desk user processing', () => 
    {    
    ...
    it.skip('should check view blade sections', () => 
    {
