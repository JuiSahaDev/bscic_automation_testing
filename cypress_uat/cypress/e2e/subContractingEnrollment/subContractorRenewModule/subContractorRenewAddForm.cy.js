...
import {subContractorRenewAddForm, deputyGeneralManagerStep1, assistantEngineerOrExecutiveOfficerStep2, deputyGeneralManagerStep3, govtPaymentFinalStep, certificateButtonCheck, viewBladeSectionsCheck} from "../../../pages/subContractingEnrollment/subContractorRenewModule/subContractorRenewAddForm"

describe('Cypress Automation for Sub Contractor Renew Add Form', () => {
    beforeEach(() => {
    ...
    {    
        // Step 5: Final approval from applicant
        applicantLoginPage();
